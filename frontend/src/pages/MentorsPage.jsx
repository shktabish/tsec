...
const teachersData = [
  { id: 1, name: 'John Peterson', role: 'Teacher', skills: ['Python', 'C++'], hourRate: 24, experience: 15 },
  { id: 2, name: 'Elevan Georgi', role: 'Teacher', skills: ['Python', 'JavaScript'], hourRate: 19, experience: 6 },
  ...
  { id: 5, name: 'Andrew Maclaren', role: 'Lector', skills: ['Python', 'Ruby'], hourRate: 34, experience: 26 },
];
  ...
  <div className="bg-[#0d1a42] p-4 rounded-lg">
    ...
    <div className="grid grid-cols-2 gap-4 mb-4">
      <div>
        ...
        <p className="text-white">Hired</p>
      </div>
      <div>
    ...
    <div className="flex justify-end items-center">
      ...
      <button className="bg-[hsl(210,100%,96%)] text-black px-4 py-2 rounded-lg">
        Connect With Mentor
      </button>
    </div>
  </div>
    ...
    <div className="text-white p-6 min-h-screen">
      <div className="flex mb-6">
        <div className="flex-1 flex items-center bg-white rounded-l-lg px-4">
          <Search className="text-gray-400 mr-2 bg-whites" />
          <input
            type="text"
            placeholder="Python"
